        ...
        <tbody class="bg-white divide-y divide-gray-200">
          {#each filteredPrograms as program, index}
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <input type="number" bind:value={program.amount} class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
